...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_smooth_scroll__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_style_styl__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_style_styl___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__styles_style_styl__);
...
function initMap() {
  ...
  sv.getPanorama({ location: fenway, radius: 250, source: google.maps.StreetViewSource.OUTDOOR }, processSVData);
}
...
function moveToNextStreetView() {
  document.querySelector('#nextStreetView').addEventListener('click', () => {
    ...
    __WEBPACK_IMPORTED_MODULE_1_smooth_scroll___default.a.animateScroll(moveTo);
  });
}
...
function fetchProjects() {
  ...
  fetch('https://www.mirrormedia.mg/api/combo?endpoint=projects', { method: 'get' }).then(function (response) {
    ...
    const rt = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.filter(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.get(data, ['_endpoints', 'projects', '_items']), function (o) {
      return o.name !== 'hot-sugar';
    });
    projectsAmount = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.get(rt, ['length'], 0);
    if (vw < 900) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.forEach(rt, function (p) {
      projects = projects + `<div class="relatedProject__project"><figure><a href="https://www.mirrormedia.mg/projects/${__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.get(p, ['slug'])}" target="_blank"><img src="${__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.get(p, ['heroImage', 'image', 'resizedTargets', 'desktop', 'url'])}"></a></figure><h3><a href="https://www.mirrormedia.mg/projects/${__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.get(p, ['slug'])}" target="_blank">${__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.get(p, ['title'])}</a></h3><p><a href="https://www.mirrormedia.mg/projects/${__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.get(p, ['slug'])}" target="_blank">${__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.truncate(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.get(p, ['brief', 'apiData', '0', 'content', '0']), { 'length': 40 })}</a></p></div>`;
    });
    ...
    __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.forEach(relatedProjects, function (p) {
...
function initialize() {
  ...
  __WEBPACK_IMPORTED_MODULE_1_smooth_scroll___default.a.init();
  audioVolumeControl();
  initMap();
...
window.onscroll = () => {
  ...
  if (scrollTop < streetViewContent[1].offsetTop + vh / 2) {
    ...
    if (currentStreetView !== 1) {
      currentStreetView = 1;
      streetViewImgSrc.src = __webpack_require__(6);
      streetViewImg.style.opacity = 1;
      streetViewImg.style.objectPosition = '60% 50%';
      changeStreetMap(fenway, 157.05);
    }
  }
  if (scrollTop > streetViewContent[0].offsetTop + vh / 2 && scrollTop < streetViewContent[1].offsetTop + vh / 2 && vw < 900) {
  ...
  if (scrollTop > streetViewContent[1].offsetTop + vh / 2 && scrollTop < streetViewContent[2].offsetTop + vh / 2) {
    const fenway = { lat: 40.7305051, lng: -73.9864521 };
  ...
  if (scrollTop > streetViewContent[2].offsetTop + vh / 2 && scrollTop < streetViewContent[3].offsetTop + vh / 2) {
    const fenway = { lat: 40.7302678, lng: -73.9869081 // need check
    };if (currentStreetView !== 3) {
      currentStreetView = 3;
      changeStreetMap(fenway, 338.8);
      streetViewImgSrc.src = __webpack_require__(7);
      streetViewImg.style.opacity = 1;
  ...
  if (scrollTop > streetViewContent[3].offsetTop + vh / 2 && scrollTop < streetViewContent[4].offsetTop + vh / 2) {
  ...
  if (scrollTop > streetViewContent[4].offsetTop + vh / 2 && scrollTop < streetViewContent[5].offsetTop + vh / 2) {
    const fenway = { lat: 40.7299459, lng: -73.9852943 };
    if (currentStreetView !== 5) {
      currentStreetView = 5;
      changeStreetMap(fenway, 162.12);
      streetViewImgSrc.src = __webpack_require__(8);
      streetViewImg.style.opacity = 1;
      streetViewImg.style.objectPosition = '50% 50%';
      pauseAllAudio();
    }
  ...
  if (scrollTop > streetViewContent[5].offsetTop + vh / 2 && scrollTop < story.offsetTop - vh / 2) {
    ...
    if (currentStreetView !== 6) {
      ...
      streetViewImgSrc.src = __webpack_require__(9);
      streetViewImg.style.opacity = 1;
      streetViewImg.style.objectPosition = '50% 50%';
      pauseAllAudio();
    }
  ...
  if (scrollTop > storyTitles[0].offsetTop + story.offsetTop - vh / 2 && gaTrackingPage < 9) {
    ga('send', 'event', 'project', 'scroll', 'scroll to 9', { nonInteraction: false });
    gaTrackingPage += 1;
  }
  if (scrollTop > storyTitles[1].offsetTop + story.offsetTop - vh / 2 && gaTrackingPage < 10) {
    ga('send', 'event', 'project', 'scroll', 'scroll to 10', { nonInteraction: false });
    gaTrackingPage += 1;
  }
  if (scrollTop > storyTitles[2].offsetTop + story.offsetTop - vh / 2 && gaTrackingPage < 11) {
    ga('send', 'event', 'project', 'scroll', 'scroll to 11', { nonInteraction: false });
    gaTrackingPage += 1;
  }
  if (scrollTop > storyTitles[3].offsetTop + story.offsetTop - vh / 2 && gaTrackingPage < 12) {
    ga('send', 'event', 'project', 'scroll', 'scroll to 12', { nonInteraction: false });
    gaTrackingPage += 1;
  }
  if (scrollTop > storyTitles[4].offsetTop + story.offsetTop - vh / 2 && gaTrackingPage < 13) {
...
module.exports = __webpack_require__.p + "4bb8b891bc082a16cffa6dd1239ca2ba.jpg";

/***/ }),
/* 7 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "fcec0122bac6f96f57c811ba7ad87e0d.jpg";

/***/ }),
/* 8 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "32344e4a5fce5975365b0a2ac683491c.jpg";

/***/ }),
/* 9 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "f755a55f83178a5c24ad095581f2906f.jpg";
